...
def line_fitter(self,linecat,line_idx,niter,input_resid_level,max_contorder,max_ladjust,adjust_preference,input_continuum_deviation,llimits,max_exclusion_level):
    ...
    while (std_resid > resid_level or continuum_dev > input_continuum_deviation) and not fit_failed:
