'''
vers. 0.1.0: Excecutes the MUSE reduction pileline in the correct order
...
def bias(rootpath,working_dir,exposure_list,exposure_list_DARK,exposure_list_TWILIGHT,calibration_dir,creating_sof,n_CPU=24):
...
def flat(rootpath,working_dir,exposure_list,exposure_list_TWILIGHT,calibration_dir,creating_sof,n_CPU=24):
...
def wavecal(rootpath,working_dir,exposure_list,exposure_list_TWILIGHT,calibration_dir,static_calibration_dir,creating_sof,n_CPU=24):
...
def lsf(rootpath,working_dir,exposure_list,exposure_list_TWILIGHT,calibration_dir,static_calibration_dir,creating_sof,n_CPU=24):
...
def twilight(rootpath,working_dir,exposure_list,exposure_list_TWILIGHT,calibration_dir,static_calibration_dir,creating_sof,n_CPU=24):
...
def science_pre(rootpath,working_dir,exposure_list,calibration_dir,ESO_calibration_dir,static_calibration_dir,skyreject,using_ESO_calibration,creating_sof,n_CPU=24):
    ...
    for exposure_ID in range(len(exposure_list)):
        ...
        for i in range(len(raw_data_list[1][:])):
            ...
            if raw_data_list[i][1] == 'SKY':
                skyhdu=fits.open(raw_data_list[i][0])
                MJDsky=skyhdu[0].header['MJD-OBS']
        ...
        # choosen_illum_sky=int(illum_index[np.argmin(np.abs(MJDsillum-MJDsky))])
        

        if creating_sof:
            f_object = open(exposure_dir+'sci_basic_object.sof', 'w')
            f_std = open(exposure_dir+'sci_basic_std.sof', 'w')
            # f_sky = open(exposure_dir+'sci_basic_sky.sof', 'w')
            ...
            for i in range(len(raw_data_list[1][:])):
                ...
                # if raw_data_list[i][1] == 'SKY': f_sky.write(raw_data_list[i][0]+'  '+raw_data_list[i][1]+'\n')
            ...
            # f_sky.write(raw_data_list[choosen_illum_sky][0]+'  '+raw_data_list[choosen_illum_sky][1]+'\n')
        ...
        os.system('export OMP_NUM_THREADS='+str(n_CPU))
        os.system('esorex --log-file=sci_basic_object.log --log-level=debug muse_scibasic --nifu=-1 --resample --saveimage=true --skyreject='+skyreject+' --merge  sci_basic_object.sof')
        os.chdir(rootpath)
        
        os.chdir(exposure_dir)
        os.system('export OMP_NUM_THREADS='+str(n_CPU))
        os.system('esorex --log-file=sci_basic_std.log --log-level=debug muse_scibasic --nifu=-1 --resample --saveimage=true --skyreject='+skyreject+' --merge  sci_basic_std.sof')
        os.chdir(rootpath)
...
def sky(rootpath,working_dir,exposure_list,calibration_dir,ESO_calibration_dir,static_calibration_dir,using_ESO_calibration,creating_sof,n_CPU=24):
    print('... SKY CREATION')
...
def modified_sky(rootpath,working_dir,exposure_list,calibration_dir,ESO_calibration_dir,static_calibration_dir,using_ESO_calibration,creating_sof,n_CPU=24):
...
def scipost(rootpath,working_dir,static_calibration_dir,exposure_list,calibration_dir,ESO_calibration_dir,using_ESO_calibration,withrvcorr,skysub,dithering_multiple_OBs,combining_OBs_dir,OB,creating_sof,n_CPU=24):
...
def musereduce(configfile=None):
    ...
    ###################################################################################################
        ...
        if config['calibration']['excecute'] == True:
            ...
            if using_ESO_calibration == False:
                bias(rootpath,working_dir,exposure_list,exposure_list_DARK,exposure_list_TWILIGHT,calibration_dir,creating_sof,n_CPU=n_CPU)
                dark(rootpath,working_dir,exposure_list,exposure_list_DARK,calibration_dir,creating_sof,n_CPU=n_CPU)
                flat(rootpath,working_dir,exposure_list,exposure_list_TWILIGHT,calibration_dir,creating_sof,n_CPU=n_CPU)
                wavecal(rootpath,working_dir,exposure_list,exposure_list_TWILIGHT,calibration_dir,static_calibration_dir,creating_sof,n_CPU=n_CPU)
        ...
        if config['sci_basic']['excecute'] == True:
            ...
            science_pre(rootpath,working_dir,exposure_list,calibration_dir,ESO_calibration_dir,static_calibration_dir,skyreject,using_ESO_calibration,creating_sof,n_CPU=n_CPU)
        ...
        if config['sky']['excecute'] == True:
            ...
            if config['sky']['modified'] == False:
                sky(rootpath,working_dir,exposure_list,calibration_dir,ESO_calibration_dir,static_calibration_dir,using_ESO_calibration,creating_sof,n_CPU=n_CPU)
            if config['sky']['modified'] == True:
                modified_sky(rootpath,working_dir,exposure_list,calibration_dir,ESO_calibration_dir,static_calibration_dir,using_ESO_calibration,creating_sof,n_CPU=n_CPU)
        ...
        if config['sci_post']['excecute'] == True:
            ...
            scipost(rootpath,working_dir,static_calibration_dir,exposure_list,calibration_dir,ESO_calibration_dir,using_ESO_calibration,withrvcorr,skysub,dithering_multiple_OBs,combining_OBs_dir,OB,creating_sof,n_CPU=n_CPU)
    if config['exp_combine']['excecute'] == True:
