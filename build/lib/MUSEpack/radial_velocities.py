...
class RV_spectrum:
    ...
    def line_fitting(self,input_cat,line_idxs,niter = 5, contorder = [1], n_CPU = -1, resid_level = None, max_contorder = 2,max_ladjust = 4, adjust_preference = 'contorder',input_continuum_deviation = 0.05, llimits = [2.,2.]):
        ...
        result = [dask.delayed(line_fitter)(self,input_cat,ldx,niter,resid_level,max_contorder,max_ladjust,adjust_preference,input_continuum_deviation,llimits) for ldx in np.array(line_idxs)]
