...
To properly run :class:`MUSEreduce.musereduce` the ESO's MUSE data reduction pipeline v2.8.1 has to be installed. The latest version including the manual and further instructions can be found under: https://www.eso.org/sci/software/pipelines/muse/.
